...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--patchPath',  help='Patch File Path')
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='cnn', help='selects model to use for netG')
