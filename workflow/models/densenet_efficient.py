...
class DenseNetEfficient(nn.Module):
    ...
    """
    def __init__(self, growth_rate=12, block_config=(16, 16, 16, 16, 16), compression=0.5, num_input_features=2,
        ...
        self.features = nn.Sequential(OrderedDict([
                ('conv0', nn.Conv2d(num_input_features, num_init_features, kernel_size=3, stride=1, padding=1, bias=False)),
            ]))
