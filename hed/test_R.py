...
net.load_state_dict(torch.load('/home/wangbin/wb/pytorch/hed/checkpoints/hed_R_8.pth'))
...
for i, image in enumerate(test_loader):
    ...
    final_output_F = output[12].cpu()

    print(i) 
    fn = name[0]

    save_dir = '/home/wangbin/wb/pytorch/hed/test/hed_R/'
